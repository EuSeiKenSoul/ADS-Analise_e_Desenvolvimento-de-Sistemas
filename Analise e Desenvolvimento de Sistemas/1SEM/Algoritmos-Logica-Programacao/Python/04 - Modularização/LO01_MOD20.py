...
#preciso garantir que a variavel A sejá maior que zero. (ok)
#preciso usar a formula de discriminante para saber se existe raizes reais. Δ=B2−4AC(ok)
#Preciso calcular a raíz quadrada (Formula de baskara)
#Apresentar os resultados computados.